...
<div class="container mt-5">
    ...
    <form action="{{ route('services.store') }}" method="POST" class="bg-dark p-5 rounded shadow-lg border border-primary modern-border">
        @csrf
        ...
        <div class="text-center mt-4">
            ...
            <a href="{{ route('services.index') }}" class="btn btn-secondary px-4 py-2 rounded-pill btn-dark-modern btn-dark-modern:hover btn-dark-modern:focus">Cancelar</a>
        </div>
    </form>
</div>
@endsection
